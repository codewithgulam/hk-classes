...
urlpatterns = [
    ...
    path('Hod/Student/Edit/<int:student_id>', Hod_views.EDIT_STUDENT, name="edit_student"),
    ...
    path('Hod/School/Add', Hod_views.ADD_SCHOOL, name='add_school'),
    path('Hod/School/View', Hod_views.VIEW_SCHOOL, name='view_school'),
    path('Hod/School/Edit/<str:id>', Hod_views.EDIT_SCHOOL, name="edit_school"),
    path('Hod/School/Update', Hod_views.UPDATE_SCHOOL, name='update_school'),
    path('Hod/School/Delete/<str:id>', Hod_views.DELETE_SCHOOL, name='delete_school'),
